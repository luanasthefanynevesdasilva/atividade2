    ...
    <div class="container">
        ...
        <form class='form' id="form" action="./editar-venda.php?id=<?= $idaluguel ?>" method="POST">
            <div class="mb-3">  
                ...
                <input type="number" step="any"  value="<?= $aluguel->gettotal() ?>" name="total" class="form-control" id="total" autocomplete="off" required>
            </div>
                            <div class="input" style="width: 25% !important;">
                <label for="pago" class="form-label">pago</label>
                <input type="number" step="any"  value="<?= $aluguel->getpago() ?>" name="pago" class="form-control" id="pago" autocomplete="off" required>
            </div>
                            <div class="input" style="width: 25% !important;">
                ...
                <input type="number" step="any"  value="<?= $aluguel->getdesconto() ?>" name="desconto" class="form-control" id="desconto" autocomplete="off" required>
            </div>
                            <div class="input" style="width: 25% !important;">
                <label for="troco" class="form-label">troco</label>
                <input type="number" step="any"  value="<?= $aluguel->gettroco() ?>" name="troco" class="form-control" id="troco" autocomplete="off" required>
            </div>
                                  <div class="mb-3">
